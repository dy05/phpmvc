    ...
    <div class="content-panel">
        <form action="" method="POST">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" id="code" name="code" placeholder="RGPD" value="<?= $old['code'] ?? null; ?>" />
            </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" id="niveau" name="niveau" placeholder="1" value="<?= $old['niveau'] ?? null; ?>" />
            </div>
